                  ...
                  <?php foreach ($rt as $key => $rt) : ?>
                    <tr>
                      ...
                      <td class="text-center">
                        <a href="<?php echo base_url('rt/detail/' . $rt['id_rt']) ?>" class="btn btn-sm btn-success">Lihat Detail</a>
                        <a href="<?php echo base_url('rt/deleteRt/' . $rt['id_rt']) ?>" class="btn btn-sm btn-danger" onclick="return confirmDelete()">Delete</a>
                      </td>
                    </tr>
                  <?php endforeach ?>
                </tbody>
